...
**Seventeen of nineteen rows have landed in full: 1, 2, 3, 4, 5, 7, 8, 9, 10,
11, 13, 14, 15, 16, 17, 18 and 19.** The two that have not are 6 and 12, and neither is
merely unscheduled: row 6 is recorded-not-built on purpose and row 12 is gated by
D21. Two of the seventeen that landed — 3 and 10 — carry a caveat worth keeping, so
